...
export const originalSpriteSize = 256; // px
export const spritePadding = 8; // px
export const desiredSpriteSize = 64; // px
export const tileSpacing = desiredSpriteSize + spritePadding; // (64 px of sprite width + total 8 px of padding)
export const tileScale = desiredSpriteSize / originalSpriteSize; // Scale down from 256px to 64px
