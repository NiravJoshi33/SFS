            ...
            <div className="bg-white rounded-xl shadow-sm text-sm font-medium border1 dark:bg-dark2 my-5">
                <div className="flex gap-3 sm:p-4 p-2.5 text-sm font-medium">
                    ...
                    <div className="flex-1">
                        <a href="timeline.html">
                            <h4 className="text-black dark:text-white"> Title-sfs </h4>
                        </a>
                        <div className="text-xs text-gray-500 dark:text-white/80"> description description descriptiondes criptiondescriptio descriptiondescription ndescription</div>
                    </div>
